...
def test_deploy_feed_reverts_on_market_token_not_weth(
    gov, dai, usdc, uni, pool_daiusdc_5bps, pool_uniweth_30bps
):
...
def test_deploy_feed_reverts_on_market_token_not_base(
    gov, weth, dai, rando, uni, pool_daiweth_30bps, pool_uniweth_30bps
):
...
def test_deploy_feed_reverts_on_market_token_not_quote(
    gov, dai, rando, uni, pool_daiweth_30bps, pool_uniweth_30bps
):
    market_pool = pool_daiweth_30bps
    ovlweth_pool = pool_uniweth_30bps
    ovl = uni
...
def test_deploy_feed_reverts_on_weth_not_in_ovlweth_pool(
    gov, weth, dai, pool_daiweth_30bps, pool_daiusdc_5bps
):
    market_pool = pool_daiweth_30bps
...
def test_deploy_feed_reverts_on_ovl_not_in_ovlweth_pool(
    gov, weth, dai, pool_daiweth_30bps, pool_uniweth_30bps
):
    market_pool = pool_daiweth_30bps
    ovlweth_pool = pool_uniweth_30bps
    ovl = dai
...
def test_deploy_feed_reverts_on_cardinal_in_market_pool(
    gov, weth, dai, uni, pool_daiweth_30bps, pool_uniweth_30bps
):
    market_pool = pool_daiweth_30bps
    ovlweth_pool = pool_uniweth_30bps
    ovl = uni
...
def test_deploy_feed_reverts_on_cardinal_in_ovlweth_pool(
    gov, weth, dai, uni, pool_daiweth_30bps, pool_uniweth_30bps
):
    market_pool = pool_daiweth_30bps
    ovlweth_pool = pool_uniweth_30bps
