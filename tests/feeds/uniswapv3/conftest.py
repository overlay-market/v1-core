import pytest
from brownie import Contract, OverlayV1UniswapV3Feed, OverlayV1NoReserveUniswapV3Feed
...
@pytest.fixture(scope="module", params=[(600,3600,200)])
def create_quanto_feed_without_reserve(gov, 
      pool_daiweth_30bps, pool_uniweth_30bps, dai, weth, request):
    micro, macro, cardinality = request.param
