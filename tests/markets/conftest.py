...
def create_feed_factory(gov, uni_factory, weth, uni, request):
    micro, macro, cardinality, block_time, decimal = request.param
    tok = uni.address
...
@pytest.fixture(
    scope="module",
    params=[(1000000000000000000, 2000000000000000000000000)],
)
...
def market(
    gov, feed, feed_factory, factory, ovl, create_market, request
):
    risk_params = request.param
    yield create_market(
        feed=feed,
