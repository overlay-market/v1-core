import pytest
from brownie import Contract, OverlayV1UniswapV3Factory, OverlayV1NoReserveUniswapV3Factory
...
def create_factory_without_reserve(gov, uni_factory, weth, request):
  ...
  def create_factory_without_reserve(univ3_factory=uni_fact, 
        micro_window=micro, macro_window=macro, cardinality_min=cardinality,
        avg_block_time=block_time):
      factory = gov.deploy(OverlayV1NoReserveUniswapV3Factory, univ3_factory,
          micro_window, macro_window, cardinality_min, avg_block_time)
      return factory
