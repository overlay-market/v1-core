...
contract v2_OverlayV1ChainlinkFeed is OverlayV1Feed {
        ...
        )
    {
        ...
        priceOverMicroWindow = (sumOfPriceMicroWindow) / (microWindow);
        priceOverMacroWindow = (sumOfPriceMacroWindow) / (macroWindow);
        priceOneMacroWindowAgo = (sumOfPriceMacroWindowAgo) / (macroWindow);
    }
}
