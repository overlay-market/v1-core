...
contract v1_OverlayV1ChainlinkFeedFactory is
    Iv1_OverlayV1ChainlinkFeedFactory,
    OverlayV1FeedFactory
{
    ...
    function deployFeed(address _aggregator) external returns (address _feed) {
        ...
        _feed = address(new v1_OverlayV1ChainlinkFeed(_aggregator, microWindow, macroWindow));
