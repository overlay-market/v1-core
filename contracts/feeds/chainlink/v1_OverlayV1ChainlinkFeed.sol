...
contract v1_OverlayV1ChainlinkFeed is OverlayV1Feed {
        ...
        )
    {
        ...
        priceOverMicroWindow = (sumOfPriceMicroWindow * (10**18)) / (microWindow * (10**18));
        priceOverMacroWindow = (sumOfPriceMacroWindow * (10**18)) / (macroWindow * (10**18));
        priceOneMacroWindowAgo = (sumOfPriceMacroWindowAgo * (10**18)) / (macroWindow * (10**18));
    }
}
