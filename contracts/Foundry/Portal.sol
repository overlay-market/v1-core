...
contract Portal is NonblockingLzApp {
    uint256 gas = 350000;
    IDemoToken iDemoToken = IDemoToken(0x87e143018574F86612352C73ADBfc781eC3f2303); // deploy demo first and pass address
    ...
    function bridgeToken(uint16 _dstChainId, uint256 _amount) public payable {
