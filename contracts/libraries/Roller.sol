...
library Roller {
    ...
    // TODO: test (particularly for overflow w castings)
    function transform(
        ...
        // TODO: check for overflow issues with uint32 ...
        uint256 dt = uint256(uint32(timestamp) - self.timestamp);
        ...
        // TODO: check for overflow with windowNow and uint32 cast down
